...
def insert_styles():
    ...
    .job-name {font-weight: bold; font-size: 1.5em; margin-top: 8px; color: var(--text); background: #000; border: 1px solid #eee; border-bottom: none; border-top-left-radius: 10px; border-top-right-radius: 10px}
    .job-specialty {font-size: 1.0em; color: var(--text); background: #000; border: 1px solid #eee; border-top: none; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px}
